...
# Filtrando os valores diferentes de 0
faturamentos_validos = [d['valor'] for d in faturamento if d['valor'] > 0]

# Calculando o menor, maior valor e média
...
dias_acima_media = len([f for f in faturamentos_validos if f > media])
